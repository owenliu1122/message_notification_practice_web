...
export default {
  ...
  created () {
    this.load = true
    this.func.ajaxGet('/apis/dashboard/groups', {page: this.currentPage, page_size: this.pageSize}, res => {
  ...
  methods: {
    ...
    handleSizeChange (val) {
      ...
      this.func.ajaxGet('/apis/dashboard/groups', {page: this.currentPage, page_size: val}, res => {
        console.log(res.data)
        this.count = res.data.count
        this.tableData = res.data.data
        this.load = false
    ...
    handlePageChange (val) {
      ...
      console.log(`每页 ${val} 条`)
      this.func.ajaxGet('/apis/dashboard/groups', {page: val, page_size: this.pageSize}, res => {
        console.log(res.data)
        this.count = res.data.count
        this.tableData = res.data.data
        this.load = false
